...
# file_path = 'emg_features_ninapro_S2_S5.csv'
...
# --- KRİTİK GÜNCELLEME: DİNAMİK SINIF TANIMLAMA ---
# Tüm olası sınıflarımızın sözlüğü
all_target_names = {
    0: 'Ex B - 1 (0)', 
    1: 'Ex B - 2 (1)', 
    2: 'Ex B - 5 (2)', 
...
# Veri setinde GERÇEKTEN var olan etiketleri bul (Örn: [0, 1, 3, 4])
...
# classification_report'a hangi etiketlerin olduğunu söylüyoruz
